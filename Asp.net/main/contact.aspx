				...
				<ul class="navbar-nav ml-auto">
					...
					<%--<li class="nav-item dropdown mr-lg-4">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="menu.aspx">Menu</a>
							<a class="dropdown-item" href="index.aspx">Services</a>
							<div class="dropdown-divider"></div>
							<a class="dropdown-item" href="about.aspx">Team</a>
						</div>
					</li>--%>
					<li class="nav-item mx-lg-2">
						...
						<div class="col-4 home-radio-clock">
							<ul class="list-unstyled">
								<li style="color:Black">
									<i class="fas fa-home mr-3" style="color:Black"></i>Address</li>
								<li class="my-5" style="color:Black" >
									<i class="fas fa-phone mr-3" ></i>Call Us</li>
								<li style="color:Black">
									<i class="far fa-clock mr-3" style="color:Black"></i>Opening Time</li>
							</ul>
						</div>
						<div class="col-8 home-radio-clock-right">
							<ul class="list-unstyled">
								<li style="color:Black">Diamond nagar,
								</li>
                                <li style="color:Black"><span>Mahuva,364290</span>
								</li>
								<li class="my-4" style="color:Black">(91) 9874560123
									<span>(91) 7585412036</span>
								</li>
								<li style="color:Black">Mon-Sat:
									<span>07h-16h</span>
								</li>
							</ul>
						</div>
			...
			<div class="container py-lg-2">
				<div class="row">
					<div class="col-lg-3 col-sm-6 w3l-footer one">
						<h2 class="index.aspx mb-3">Wake up cafe</h2>
					...
					<div class="col-lg-4 col-sm-6 w3l-footer three mt-lg-0 mt-4">
						...
						<ul class="list-unstyled">
							<li>
								...
								<p>The company name
									<span>Wake up cafe</span>Diamon nagar,mahuva-364290</p>
								<div class="clearfix"></div>
							</li>
							<li class="my-2">
