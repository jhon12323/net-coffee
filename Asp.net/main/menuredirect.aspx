			...
			<ul id="flexiselDemo1">
				<li>
					<div class="w3layouts_banner_bottom_left">
						<a href="order.aspx"><img src="images/b3.jpg" alt=" " class="img-fluid" style="width:300px; height:200px ;" /></a>
				...
				<li>
					<div class="w3layouts_banner_bottom_left">
						<a href="order.aspx"><img src="images/c3.jpg" alt=" " class="img-fluid" style="width:300px; height:200px ;"/></a>
						<h4>Cappuccino ---
							<span>RS-/200</span>
						</h4>
						<p>Morbi eu justo suscipit.</p>
				...
				<li>
					<div class="w3layouts_banner_bottom_left">
						<a href="order.aspx"><img src="images/k.jpg" alt=" " class="img-fluid" style="width:300px; height:200px ;" /></a>
						<h4>Flat White ---
							<span>RS-/100</span>
						</h4>
						<p>Morbi eu justo suscipit.</p>
				...
				<li>
					<div class="w3layouts_banner_bottom_left">
						<a href="order.aspx"><img src="images/g4.jpg" alt=" " class="img-fluid" style="width:300px; height:200px ;"/></a>
						<h4>Caffe Macchiato ---
							<span>RS-/125</span>
						</h4>
						<p>Morbi eu justo suscipit.</p>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 w3_cuisine_names_left w3l_cuisine_names_left text-right" 
					...
					<h3><a href="order.aspx">Coffee Americano -----
						RS-/150</h3>
					<h3 style="font-family: 'Century Gothic'"><a href="order.aspx">Cafe Latte -----
						RS-/100
					</h3>
					<h3 style="font-family: 'Century Gothic'"><a href="order.aspx">Espresso -----
						RS-/200
					</h3>
					<h3 style="font-family: 'Century Gothic'"><a href="order.aspx">Cappuccino -----
						RS-/95
					</h3>
					<h3 style="font-family: 'Century Gothic'"><a href="order.aspx">Coffee Macchiato -----
						RS-/125
					</h3>
				</div>
				...
				<div class="col-md-4 w3_cuisine_names_left py-md-0 py-4">
					<h3><a href="order.aspx">Caffe Mocha -----
						RS-/125</a></h3>
					<h3><a href="order.aspx">Flat white -----
						RS-/200</h3>
					<h3><a href="order.aspx">Long black -----
						RS-/80</h3>
					<h3><a href="order.aspx">Irish Coffee -----
						RS-/100</h3>
					<h3><a href="order.aspx">Affogato -----
						RS-/130</h3>
				</div>
			</div>
		</div>
			...
			<div class="container py-lg-2">
				<div class="row">
					<div class="col-lg-3 col-sm-6 w3l-footer one">
						<h2 class="index.aspx mb-3">Wakeup Cafe</h2>
					...
					<div class="col-lg-4 col-sm-6 w3l-footer three mt-lg-0 mt-4">
						...
						<ul class="list-unstyled">
							<li>
								...
								<p>The company name
									<span>Wake up cafe</span>Diamond nagar,Mahuva-364290</p>
								<div class="clearfix"></div>
							</li>
							<li class="my-2">
